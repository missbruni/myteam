  ...
  return (
    <div className="relative h-20 min-w-[200px] mb-10">
      <textarea
        required={required}
        placeholder={label}
        className="peer h-full w-full border-b border-white bg-transparent pt-2 pb-1.5 pl-4 outline outline-0 transition-all focus:border-emerald-300 text-white placeholder:text-gray-500 focus:outline-0 disabled:border-gray-500 invalid:[&:not(:placeholder-shown)]:border-[#f67e7e]"
      />
      ...
      {errorText && (
        <p className="mt-1 invisible text-[#f67e7e] text-[12px] italic peer-invalid:visible">
          {errorText}
        </p>
      )}
    </div>
